...
from keyboards.inline.user import user_like_button_def, follow_inline_button
...
async def follow_user(call: types.CallbackQuery, state: FSMContext):
    ...
    await bot.send_message(chat_id=user_chat_id, text=f"Ushbu foydalanuvchi szga follow bosdi {chat_id}")
